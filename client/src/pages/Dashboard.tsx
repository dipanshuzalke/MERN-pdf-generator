...
import { Plus, FileText, Download, TrendingUp, Calendar, DollarSign } from 'lucide-react';
    ...
    <main className="relative min-h-screen w-full bg-[#18181b] flex flex-col overflow-x-hidden">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button onClick={() => navigate('/add-products')} className='bg-[#23232a] border border-lime-400 text-lime-400 hover:bg-lime-200 hover:text-black font-semibold flex items-center px-8 py-2 h-12 rounded-md shadow-none'>
          ...
          <CardContent>
            {invoices.length === 0 ? (
              <div className="text-center py-12">
                ...
                <Button onClick={() => navigate('/add-products')} className='bg-[#23232a] text-lime-400 hover:bg-lime-200 hover:text-black font-semibold py-5 px-14 rounded-lg text-lg '>
                  <Plus className="h-4 w-4 mr-2" />
                  Create Invoice
                </Button>
              </div>
